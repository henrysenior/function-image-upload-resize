            ...
            ILogger log)
        {
            try
            {
                if (input != null)
                {
                    ...
                    if (encoder != null)
                    {
                        var searchResultWidth = Convert.ToInt32(Environment.GetEnvironmentVariable("SEARCH_RESULT_WIDTH"));
                        var searchResultContainerName = Environment.GetEnvironmentVariable("SEARCH_RESULT_CONTAINER_NAME");
